...
- Variables : Différence entre valeur, type et nom de variable. Variables locales (avec `in`). Définitino, utilisation d'une variable et d'une référence. int, float, unit. 
